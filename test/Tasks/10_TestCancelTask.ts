...
import { acceptRequest, cancelTask, getTask } from "../../utils/taskHelper";
...
describe("Cancel task", function () {
  ...
  it("should have the correct metadata", async function () {
    ...
    expect(taskInfo.cancelTaskRequests[0].accepted).to.be.null;
    ...
    expect(taskInfo2.cancelTaskRequests[0].accepted).to.be.not.null;
  });
